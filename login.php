<h1 style="text-align: center;" class="blue-text">LOGIN!</h1>
<div class="card" style="padding: 50px; width: 40%; margin: 0 auto; margin-top: 15%;">
	<form method="POST">
	...
	<center><h3><a href="index.php" class="btn btn-lg btn-secondary"><i class="material-icons">home</i></a></h3></center>
</div>
<?php 
