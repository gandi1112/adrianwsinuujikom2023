          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#user"><img class="circle" src="../img/petu.jpg"></a>
                      <a href="#name"><span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a>
                  </div>
              </li>
              <li><a href="index.php?p=dashboard" class="btn btn-lg btn-secondary">Dashboard</a>
              <li><a href="index.php?p=pengaduan" class="btn btn-lg btn-secondary">Pengaduan</a>
              <li><a href="index.php?p=respon" class="btn btn-lg btn-secondary">Respon</a>
              <li>
                  <div class="divider"></div>
              </li>
              <li><a class="btn btn-lg btn-secondary" href="../index2.php?p=logout">Logout</a>
          </ul>
