	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn teal modal-trigger" href="#user_edit<?php echo $r['id_petugas'] ?>">Edit</a> <a class="red btn" onclick="return confirm('Anda Yakin Ingin Menghapus OK/Cancel')" href="index.php?p=user_hapus&id_petugas=<?php echo $r['id_petugas'] ?>">Hapus</a></td>
