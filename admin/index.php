    ...
    <div class="row">
      <div class="col s12 m3">
          <ul id="slide-out" class="sidenav sidenav-fixed">
              ...
              <li><a href="index.php?p=dashboard" class="btn btn-lg btn-secondary"><i class="material-icons">dashboard</i>Dashboard</a>
              <li><a href="index.php?p=registrasi" class="btn btn-lg btn-secondary"><i class="material-icons">featured_play_list</i>Registrasi</a>
              <li><a href="index.php?p=pengaduan" class="btn btn-lg btn-secondary"><i class="material-icons">report</i>Pengaduan</a>
              <li><a href="index.php?p=respon" class="btn btn-lg btn-secondary"><i class="material-icons">question_answer</i>Respon</a>
              <li><a href="index.php?p=user" class="btn btn-lg btn-secondary"><i class="material-icons">account_box</i>User</a>
              <li><a href="index.php?p=laporan" class="btn btn-lg btn-secondary"><i class="material-icons">book</i>Laporan</a>
              <li>
                  <div class="divider"></div>
              </li>
              <li><a class="btn btn-lg btn-secondary" href="../index2.php?p=logout"><i class="material-icons">logout</i>Logout</a>
          </ul>
